...
export function MindMapBlockView({ block, onContextMenu }: Props) {
  ...
  return (
    ...
    <BlockWrapper block={block} kind="mindmap" onContextMenu={onContextMenu}>
      ...
      >
        <div className="absolute left-3 top-2 z-10 font-mono text-[14px] uppercase tracking-wider text-amber-500">Mind Map</div>
        ...
        {visibleNodes.map((n) => {
          ...
          return (
            <div
              ...
              className={`group/node absolute -translate-x-1/2 -translate-y-1/2 cursor-pointer border-2 text-[17px] font-semibold text-black shadow-lg select-none ${shapeCls}`}
              style={{
                left: n.dx,
                top: n.dy,
                background: n.color,
            ...
            >
              ...
              {menuId === n.id && (
                <div
                  ...
                  onPointerDown={(e) => e.stopPropagation()}
                >
                  <div className="mb-1 text-[14px] font-mono uppercase tracking-wider text-neutral-500">Shape</div>
                  ...
                  <div className="mt-1 mb-1 text-[14px] font-mono uppercase tracking-wider text-neutral-500">Color</div>
                  <div className="flex gap-1">
                    {COLORS.map((c) => (
                      <button
                        key={c}
                ...
                >
                  ...
                  <div className="flex items-center justify-between border-b border-[#2a2a2a] px-6 py-4">
                    <div className="flex-1">
                      <div className="font-mono text-[14px] uppercase tracking-wider text-amber-500">Mind Map Node</div>
                      <input
                        autoFocus
