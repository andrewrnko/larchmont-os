  ...
  return (
    <BlockWrapper block={block} kind="sticky" onContextMenu={onContextMenu}>
      ...
      >
        ...
        <textarea
          ref={taRef}
          className="h-full w-full resize-none whitespace-pre-wrap break-words bg-transparent p-4 pt-6 text-[16px] leading-relaxed text-black/80 outline-none placeholder:text-black/30"
