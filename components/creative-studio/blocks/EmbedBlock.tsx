    ...
    <BlockWrapper block={block} kind="embed" onContextMenu={onContextMenu}>
      <div className="flex h-full w-full flex-col overflow-hidden rounded-lg border border-[#2a2a2a] bg-[#111] shadow-lg">
        {block.url ? (
          <>
            ...
            <div className="flex flex-1 flex-col justify-between p-4">
              <div>
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    {block.description && (
                      <div className="mt-1 text-[13px] text-neutral-500 line-clamp-3 leading-relaxed">
                        {block.description}
                      </div>
                    )}
                  </>
              ...
              <a
                ...
                className="mt-2 flex items-center gap-1 self-start rounded bg-amber-600/20 px-2 py-1 text-[12px] text-amber-400 hover:bg-amber-600/40"
          ...
          <div className="flex h-full items-center justify-center p-4 text-[13px] text-neutral-500">
