        ...
        {logOpen && (
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              <span className="font-mono text-[11px] uppercase text-amber-500">Repeatables History</span>
              <button onClick={() => setLogOpen(false)} className="text-neutral-500 hover:text-white">
                <X size={14} />
              </button>
            </div>
            {log.length === 0 && <div className="text-[11px] text-neutral-600">No history yet. Complete a full day to see data.</div>}
