...
export function CreativeStudioClient() {
  ...
  if (!hydrated || !plannerHydrated) {
    return (
      <div className="flex h-full w-full items-center justify-center text-[14px] text-neutral-500">
    ...
    return (
      <div className="flex h-full w-full items-center justify-center">
        <div className="rounded-lg border border-[#2a2a2a] bg-[#141414] p-8 text-center">
          <div className="font-mono text-[14px] uppercase tracking-[0.08em] text-amber-500">Creative Studio</div>
          <h2 className="mt-2 text-xl font-semibold text-white">Nothing here yet</h2>
          <button
            onClick={() => createBoard('My First Board', '🎬')}
            className="mt-4 rounded bg-amber-500 px-4 py-2 text-sm font-medium text-black hover:bg-amber-400"
          >
